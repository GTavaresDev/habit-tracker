  ...
  <main class="relative min-h-[calc(100vh-152px)] overflow-hidden px-4 py-10 sm:px-6 lg:px-8">
    ...
    <div class="mx-auto w-full max-w-md">
      <section class="rounded-3xl border border-white/20 bg-white/10 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
        <p class="text-sm font-medium uppercase tracking-wider text-cyan-200">Editar hábito</p>
        <h1 class="mt-2 text-3xl font-semibold text-white">Editar hábito</h1>
        ...
        <form action="{{ route('site.update-habit', $habit->id) }}" method="POST" class="mt-8 space-y-5">
          @csrf
          @method('PUT')
